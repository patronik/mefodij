...
#include "joiner/bool/cast/BoolCastJoiner.h"
...
#include "joiner/int/cast/IntCastJoiner.h"
...
#include "joiner/null/cast/NullCastJoiner.h"
...
#include "joiner/array/cast/ArrayCastJoiner.h"
...
#include "joiner/double/cast/DoubleCastJoiner.h"
#include "joiner/double/string/DoubleStringJoiner.h"
#include "joiner/cast/bool/CastBoolJoiner.h"
#include "joiner/cast/int/CastIntJoiner.h"
#include "joiner/cast/null/CastNullJoiner.h"
#include "joiner/cast/array/CastArrayJoiner.h"
#include "joiner/cast/double/CastDoubleJoiner.h"
#include "joiner/cast/cast/CastCastJoiner.h"
#include "joiner/cast/string/CastStringJoiner.h"
...
#include "joiner/string/cast/StringCastJoiner.h"
...
class Interpreter : public Parser
{
    ...
    static unique_ptr<BoolCastJoiner> boolCastJoiner;
    ...
    static unique_ptr<IntCastJoiner> intCastJoiner;
    ...
    static unique_ptr<NullCastJoiner> nullCastJoiner;
    ...
    static unique_ptr<ArrayCastJoiner> arrayCastJoiner;
    ...
    static unique_ptr<DoubleCastJoiner> doubleCastJoiner;
    static unique_ptr<DoubleStringJoiner> doubleStringJoiner;
    static unique_ptr<CastBoolJoiner> castBoolJoiner;
    static unique_ptr<CastIntJoiner> castIntJoiner;
    static unique_ptr<CastNullJoiner> castNullJoiner;
    static unique_ptr<CastArrayJoiner> castArrayJoiner;
    static unique_ptr<CastDoubleJoiner> castDoubleJoiner;
    static unique_ptr<CastCastJoiner> castCastJoiner;
    static unique_ptr<CastStringJoiner> castStringJoiner;
    ...
    static unique_ptr<StringCastJoiner> stringCastJoiner;
